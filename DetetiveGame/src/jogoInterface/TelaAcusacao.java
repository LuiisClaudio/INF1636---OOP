...
public class TelaAcusacao extends JFrame {
	private JCheckBox s1, s2, s3, s4, s5, s6, a1, a2, a3, a4, a5, a6, c1, c2, c3, c4, c5, c6, c7, c8, c9;
	private Container container;
	private JButton Confirma;
	public String[] retornando;
	private boolean flag2;
	public TelaAcusacao(ControleDeJogo controlaJogadores) {
		
		retornando = new String[3];
		Confirma = new JButton("Confirmar Acusacao");
		...
		s1.addActionListener(new TratadorAcusacao(s1, Confirma, controlaJogadores, this));
		s2.addActionListener(new TratadorAcusacao(s2, Confirma, controlaJogadores, this));
		s3.addActionListener(new TratadorAcusacao(s3, Confirma, controlaJogadores, this));
		s4.addActionListener(new TratadorAcusacao(s4, Confirma, controlaJogadores, this));
		s5.addActionListener(new TratadorAcusacao(s5, Confirma, controlaJogadores, this));
		s6.addActionListener(new TratadorAcusacao(s6, Confirma, controlaJogadores, this));

		a1.addActionListener(new TratadorAcusacao(a1, Confirma, controlaJogadores, this));
		a2.addActionListener(new TratadorAcusacao(a2, Confirma, controlaJogadores, this));
		a3.addActionListener(new TratadorAcusacao(a3, Confirma, controlaJogadores, this));
		a4.addActionListener(new TratadorAcusacao(a4, Confirma, controlaJogadores, this));
		a5.addActionListener(new TratadorAcusacao(a5, Confirma, controlaJogadores, this));
		a6.addActionListener(new TratadorAcusacao(a6, Confirma, controlaJogadores, this));

		c1.addActionListener(new TratadorAcusacao(c1, Confirma, controlaJogadores, this));
		c2.addActionListener(new TratadorAcusacao(c2, Confirma, controlaJogadores, this));
		c3.addActionListener(new TratadorAcusacao(c3, Confirma, controlaJogadores, this));
		c4.addActionListener(new TratadorAcusacao(c4, Confirma, controlaJogadores, this));
		c5.addActionListener(new TratadorAcusacao(c5, Confirma, controlaJogadores, this));
		c6.addActionListener(new TratadorAcusacao(c6, Confirma, controlaJogadores, this));
		c7.addActionListener(new TratadorAcusacao(c7, Confirma, controlaJogadores, this));
		c8.addActionListener(new TratadorAcusacao(c8, Confirma, controlaJogadores, this));
		c9.addActionListener(new TratadorAcusacao(c9, Confirma, controlaJogadores, this));
		Confirma.addActionListener(new TratadorAcusacao(c1, Confirma, controlaJogadores, this));
...
class TratadorAcusacao implements ActionListener {
	private JButton Confirma;
	private JCheckBox Checkbox;
	private static int Contador = 0;
	static private ArrayList<String> selecionados;
	private String[] reajuste;
	private Acusando Acusacao;
	private ControleDeJogo controll;
	private JFrame tela_acusacao;
	public TratadorAcusacao(JCheckBox c, JButton botao, ControleDeJogo controlaJogadores, JFrame telaAcusacao) {
		tela_acusacao = telaAcusacao;
		reajuste = new String[3];
		Confirma = botao;
		Checkbox = c;
		selecionados = new ArrayList<String>();
		Acusacao = new Acusando();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() instanceof JButton) {
			...
			reajuste = Acusacao.get(selecionados, reajuste, controll);
			//reajuste = te.get();
			for(int i = 0; i <reajuste.length; i++){
				System.out.println("Tentativa "+i +": "  +reajuste[i]);
			}
			controll.retorno_confirmar_acusacao();
			tela_acusacao.setVisible(false);
...
class Acusando {
	...
	String[] get(ArrayList<String> c, String[] w,ControleDeJogo controlaJogadores) {
		...
		controlaJogadores.insere_acusacao(a);
		return a;
